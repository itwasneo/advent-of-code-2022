...
from solutions.day_12_1_2 import *
from solutions.day_13 import *
from solutions.day_14_1_2 import *
...
class TestSolutions(unittest.TestCase):
    ...
    def test_day_11_1(self):
        self.assertEqual(day_11_1(), 102399, "Expected 102399")

    def test_day_11_2(self):
        self.assertEqual(day_11_2(), 23641658401, "Expected 23641658401")

    def test_day_12(self):
        self.assertEqual(day_12_1(), 440, "Expected 440")
        self.assertEqual(day_12_2(), 439, "Expected 439")

    def test_day_13(self):
        self.assertEqual(day_13(), (5905, 21582), "Expected (5905, 21582)")

    def test_day_14(self):
        self.assertEqual(day_14_1_2(), (1513, 22646), "Expected (1513, 22646)")
